...
public class Stegano1
{
        ...
        try {
            ...
            while (line != null) {
                ...
                if(i < binString.length()){
                    if(binString.charAt(i) == 48){ //if the character at i is 0  (48 is the ascii value of 0) then a single space will be appended to the end of the line
                        line+= " ";
                    }
                    else if (binString.charAt(i) == 49){ //if the character at i is 1 (49 is the ascii value of 1) then two spaces will be appended to the end of the line
                        line += "  ";
                    }
                }
                i++;//increment i
    ...
    static void retrieve(String inpFile) {
        ...
        try {
            ...
            while (line != null) {
                // Your code starts here
                if (line.contains(" ")) { //if the line has a single space a 1 is added to the bitstring
                    binString += "1";
                } else if (line.contains("  ")) { //if the line has two spaces a 0 is added to the bitstring
                    binString += "0";
                }
            }
            //if(!isSpace) break;
